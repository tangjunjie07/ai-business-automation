                      ...
                      <div className="flex flex-wrap gap-2 mb-2">
                        {message.message_files.map((file, fileIdx) => {
                          ...
                          if (isImage) {
                            ...
                            return (
                              <div key={fileIdx} className="group/file-item relative h-[68px] w-[144px] rounded-lg border-[0.5px] border-white/20 bg-white/10 p-2 shadow-xs hover:bg-white/20">
                                <div className="system-xs-medium mb-0 h-auto cursor-pointer break-all text-white/80" title={file.name}>
                                  {file.name}
                                </div>
                                <div className="relative flex items-center justify-between">
                                  <div className="system-2xs-medium-uppercase flex items-center text-white/80">
                                    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="remixicon shrink-0 size-4 mr-1 text-red-400">
                                  ...
                                  <button type="button" className="action-btn action-btn-m absolute -right-1 -top-1 hidden group-hover/file-item:flex">
